(function($) {
  var relevant = {
    ...
    onResize: function(event) {
      ...
      this.$walking.height(M.screenHeight + this.sceneHeight);
      this.walkingHeight = this.$walking.height();
      this.difHeight = this.walkingHeight - M.screenHeight;
    },

    onScroll: function(event) {
      var scrollTop = $(window).scrollTop();
      var walkingOffset = this.$walking.offset().top;
      ...
      } else if ( distance >= 0 && distance < this.difHeight ) {
